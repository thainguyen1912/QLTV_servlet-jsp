        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            ...
            <form action="Check_DocGia_Servlet">
                ...
                <div style="float: left; margin-left: 72.5%; margin-top: 2%; <%=disabled %>">
                    <a href="trangchu_muonsach.jsp"><button style="background-color: #30a5ff;height: 31px;line-height: 2px;" type="submit" class="btn btn-info add-new"><span class="fa fa-arrow-circle-o-right"></span>  Continues</button></a>
                </div>
