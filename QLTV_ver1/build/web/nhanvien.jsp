                    ...
                    <div class="row">
                        ...
                        <form action="Search_NhanVien_Servlet">
                            <div style="width:48%; float: left">
                                <input id="manv" type="text" name="manv_search" style="font-size: 14px;border-radius: 4px;height: 30px;border-style: groove;width: 220px; margin-left: 38%;" placeholder="  search here.. " required> 
                        ...
                        <div style="width: 12%" class="col-sm-4">
                            <a href="them_nhanvien.jsp"><button style="background-color: #30a5ff" type="button" class="btn btn-info add-new"><i class="fa fa-plus"></i> Add New</button></a>
                        </div>
                    </div>
                </div>
