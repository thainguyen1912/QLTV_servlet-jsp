    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu" style="margin: 0px">
                <li class="active table_hover"><a href="thongtin_admin.jsp"><span class="glyphicon glyphicon-th-list"></span> Thông Tin Cá Nhân</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            ...
            <div class="row">
                ...
                <div style="float: left; margin-left: 39%; margin-top: 2%;">
                    <a href="suathongtin_admin.jsp"><button style="background-color: #30a5ff;height: 31px;line-height: 2px;" type="submit" class="btn btn-info add-new"><span class="fa fa-arrow-circle-o-right"></span>  Sửa Đổi Và Cập Nhật</button></a>
                </div>
