 ...
 * @author thain
 */
public class Manager_TraSach_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String hanhdong = context.getAttribute("context").toString();

        if (hanhdong.equals("pay_pm")) {
            ...
            tldao.update_slTaiLieu(matl, slcon + slm);
            
            dgdao.update_SoLuongTaiLieu_SoDuTaiKhoan(dg.getSoLuongTaiLieu() + slm, dg.getSoDuTaiKhoan() + slm*giaTien, mdg);
